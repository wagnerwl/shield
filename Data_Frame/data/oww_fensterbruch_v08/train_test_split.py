...
# ==========================================
SOURCE_POS = "Data_Frame/data/DataSet_Glassbruch_all_v04/oww_ready_sounds"

# ==========================================
# 2. DEIN ZIEL-ORDNER (OpenWakeWord Struktur)
# ==========================================
# Das ist der Pfad, den das Skript aus deiner config generiert:
TARGET_BASE = "Data_Frame/data/oww_fensterbruch_v08"

# ==========================================
# 3. SPLIT-EINSTELLUNGEN
# ==========================================
TEST_SIZE = 0.20  # 20 % der Daten für den Test, 80 % für das Training (Empfohlen)
